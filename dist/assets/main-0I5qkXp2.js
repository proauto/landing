(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function e(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=e(s);fetch(s.href,i)}})();const m=sessionStorage.getItem("spa-path");m&&(sessionStorage.removeItem("spa-path"),console.log("SPA fallback detected, storing path:",m),window.spaFallbackPath=m);const b="modulepreload",x=function(t){return"/"+t},g={},y=function(o,e,a){let s=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),r=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));s=Promise.allSettled(e.map(c=>{if(c=x(c),c in g)return;g[c]=!0;const d=c.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":b,d||(l.as="script"),l.crossOrigin="",l.href=c,r&&l.setAttribute("nonce",r),document.head.appendChild(l),d)return new Promise((h,v)=>{l.addEventListener("load",h),l.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(n){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=n,window.dispatchEvent(r),!r.defaultPrevented)throw n}return s.then(n=>{for(const r of n||[])r.status==="rejected"&&i(r.reason);return o().catch(i)})};function w(){const o=(window.location.pathname.split("/").pop()||"index.html").replace(".html",""),e=document.querySelectorAll(".nav-item"),a=document.querySelector(".nav-indicator"),s=document.querySelector(".main-header");if(!a||!s)return;function i(){e.forEach(r=>{const c=r.getAttribute("data-page");c===o||o==="index"&&!c?r.classList.add("current-page"):r.classList.remove("current-page")}),n()}function n(r){const c=r||document.querySelector(".nav-item.current-page");if(c&&a){const d=c.getBoundingClientRect(),u=s.getBoundingClientRect(),l=d.left-u.left;a.style.left=`${l}px`,a.style.width=`${d.width}px`,a.classList.add("active")}else c||a.classList.remove("active")}i(),window.addEventListener("resize",()=>n()),e.forEach(r=>{r.addEventListener("mouseenter",function(){n(this)})}),s.addEventListener("mouseleave",function(){n()}),e.forEach(r=>{r.hasAttribute("data-path")||r.addEventListener("click",function(c){c.preventDefault();const d=this.getAttribute("href");this.classList.add("clicked"),setTimeout(()=>{window.location.href=d},150)})})}function k(){if(!document.querySelector("#animation-keyframes")){const e=document.createElement("style");e.id="animation-keyframes",e.textContent=`
        ...
        `,document.head.appendChild(e)}const t={threshold:.1,rootMargin:"0px 0px -50px 0px"},o=new IntersectionObserver(function(e){e.forEach(a=>{if(a.isIntersecting){const s=a.target.getAttribute("data-delay")||0;setTimeout(()=>{a.target.classList.add("animated")},s),o.unobserve(a.target)}})},t);S(o)}function S(t){const o=window.location.pathname.split("/").pop()||"index.html";o==="brand.html"?E(t):(o==="index.html"||o==="")&&P(t);const e=document.querySelector(".footer-content");e&&(e.classList.add("animate-fade-in"),e.setAttribute("data-delay","100"),t.observe(e))}function E(t){[{selector:".brand-title",delay:100},{selector:".brand-subtitle",delay:200},{selector:".brand-divider",delay:600},{selector:".brand-question",delay:700},{selector:".work-title",delay:100},{selector:".work-cards-container",delay:200}].forEach(({selector:a,delay:s})=>{const i=document.querySelector(a);i&&(i.classList.add("animate-fade-in"),i.setAttribute("data-delay",s.toString()),t.observe(i))}),document.querySelectorAll(".brand-circle").forEach((a,s)=>{a.classList.add("animate-fade-in"),a.setAttribute("data-delay",(300+s*100).toString()),t.observe(a)})}function P(t){[{selector:".middle-image",delay:100},{selector:".service-main-text",delay:200},{selector:".service-description-text",delay:300}].forEach(({selector:n,delay:r})=>{const c=document.querySelector(n);c&&(c.classList.add("animate-fade-in"),c.setAttribute("data-delay",r.toString()),t.observe(c))}),document.querySelectorAll(".work-card").forEach((n,r)=>{n.classList.add("animate-fade-in-up"),n.setAttribute("data-delay",(100+r*150).toString()),t.observe(n)});const a=document.querySelector(".mission-content");a&&(a.classList.add("animate-fade-in-up"),a.setAttribute("data-delay","100"),t.observe(a)),document.querySelectorAll(".team-member").forEach((n,r)=>{n.classList.add("animate-fade-in-up"),n.setAttribute("data-delay",(100+r*200).toString()),t.observe(n)});const i=document.querySelector(".contact-content");i&&(i.classList.add("animate-fade-in-up"),i.setAttribute("data-delay","100"),t.observe(i))}function A(){const t=document.querySelector(".contact-form");if(!t)return;t.addEventListener("submit",R);const o=t.querySelector(".submit-button");o&&o.addEventListener("click",z)}async function R(t){t.preventDefault();const o=L(this);if(!q(o))return;const e=this.querySelector(".submit-button"),a=e.textContent;f(e,!0);try{await new Promise(s=>setTimeout(s,1e3)),console.log("Form submission:",o),alert("제안이 성공적으로 전송되었습니다!\\n\\n문의사항은 previtlab@gmail.com으로 직접 연락 부탁드립니다."),this.reset()}catch(s){console.error("Form submission error:",s),alert("전송 중 오류가 발생했습니다. 다시 시도해주세요.")}finally{f(e,!1,a)}}function L(t){const o=t.querySelectorAll("input"),e={};return o.forEach(a=>{const s=a.placeholder;s&&(e[s]=a.value.trim())}),{name:e.이름||"",email:e.이메일||"",company:e.회사명||"",phone:e.연락처||"",proposal:e["제안 사항"]||""}}function q(t){return!t.name||!t.email||!t.proposal?(alert("이름, 이메일, 제안 사항은 필수 입력 항목입니다."),!1):/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.email)?t.phone&&t.phone.length>0&&!/^[0-9-+\s()]+$/.test(t.phone)?(alert("올바른 연락처 형식을 입력해주세요."),!1):!0:(alert("올바른 이메일 주소를 입력해주세요."),!1)}function f(t,o,e="제안 보내기"){o?(t.textContent="전송 중...",t.disabled=!0):(t.textContent=e,t.disabled=!1)}function z(t){const o=t.currentTarget,e=document.createElement("span"),a=o.getBoundingClientRect(),s=Math.max(a.width,a.height),i=t.clientX-a.left-s/2,n=t.clientY-a.top-s/2;e.style.cssText=`
        width: ${s}px;
        height: ${s}px;
        left: ${i}px;
        top: ${n}px;
        ...
        pointer-events: none;
    `,o.style.position="relative",o.style.overflow="hidden",o.appendChild(e),setTimeout(()=>{e.remove()},600)}function F(){const t=window.location.pathname.split("/").pop()||"index.html";if(t!=="index.html"&&t!=="")return;const o={logoImage:document.querySelector(".logo-image"),logo:document.querySelector(".logo"),mainCopy:document.querySelector(".main-copy"),subCopy:document.querySelector(".sub-copy")};T(o),C()}function T({logoImage:t,logo:o,mainCopy:e,subCopy:a}){if(t&&(t.style.cssText=`
            opacity: 0;
        ...
        `,setTimeout(()=>{e.style.opacity="1",e.style.transform="translateY(0)"},700)),a&&(a.style.cssText=`
            ...
            transform: translateY(30px);
            transition: opacity 1s ease, transform 1s ease;
        `,setTimeout(()=>{a.style.opacity="1",a.style.transform="translateY(0)"},900))}function C(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",function(o){o.preventDefault();const e=document.querySelector(this.getAttribute("href"));e&&e.scrollIntoView({behavior:"smooth",block:"start"})})})}function I(){return`
        <!-- Hero Section -->
    ...
    `}let p;document.addEventListener("DOMContentLoaded",function(){console.log("DOM loaded, initializing SPA"),y(async()=>{const{default:t}=await import("./router-cNrh3oAD.js");return{default:t}},[]).then(({default:t})=>{p=new t,p.addRoute("/",I),p.addRoute("/brand",D),p.addRoute("/product",_),p.addRoute("/blog",B),console.log("Routes registered:",Array.from(p.routes.keys())),p.init(),window.router=p,window.spaFallbackPath&&(console.log("Processing SPA fallback path:",window.spaFallbackPath),setTimeout(()=>{p.navigate(window.spaFallbackPath),delete window.spaFallbackPath},50))}),w(),k(),A(),F(),document.body.style.opacity="0",document.body.style.transition="opacity 0.5s ease",setTimeout(()=>{document.body.style.opacity="1"},100),console.log("PreVIT SPA loaded successfully")});
