(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=e(s);fetch(s.href,i)}})();const y="modulepreload",w=function(t,o){return new URL(t,o).href},h={},S=function(o,e,a){let s=Promise.resolve();if(e&&e.length>0){const r=document.getElementsByTagName("link"),n=document.querySelector("meta[property=csp-nonce]"),c=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));s=Promise.allSettled(e.map(l=>{if(l=w(l,a),l in h)return;h[l]=!0;const u=l.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(!!a)for(let m=r.length-1;m>=0;m--){const g=r[m];if(g.href===l&&(!u||g.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${l}"]${f}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":y,u||(p.as="script"),p.crossOrigin="",p.href=l,c&&p.setAttribute("nonce",c),document.head.appendChild(p),u)return new Promise((m,g)=>{p.addEventListener("load",m),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(r){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=r,window.dispatchEvent(n),!n.defaultPrevented)throw r}return s.then(r=>{for(const n of r||[])n.status==="rejected"&&i(n.reason);return o().catch(i)})};function k(){const o=(window.location.pathname.split("/").pop()||"index.html").replace(".html",""),e=document.querySelectorAll(".nav-item"),a=document.querySelector(".nav-indicator"),s=document.querySelector(".main-header");if(!a||!s)return;function i(){e.forEach(n=>{const c=n.getAttribute("data-page");c===o||o==="index"&&!c?n.classList.add("current-page"):n.classList.remove("current-page")}),r()}function r(n){const c=n||document.querySelector(".nav-item.current-page");if(c&&a){const l=c.getBoundingClientRect(),u=s.getBoundingClientRect(),f=l.left-u.left;a.style.left=`${f}px`,a.style.width=`${l.width}px`,a.classList.add("active")}else c||a.classList.remove("active")}i(),window.addEventListener("resize",()=>r()),e.forEach(n=>{n.addEventListener("mouseenter",function(){r(this)})}),s.addEventListener("mouseleave",function(){r()}),e.forEach(n=>{n.addEventListener("click",function(c){c.preventDefault();const l=this.getAttribute("href");this.classList.add("clicked"),setTimeout(()=>{window.location.href=l},150)})})}function E(){if(!document.querySelector("#animation-keyframes")){const e=document.createElement("style");e.id="animation-keyframes",e.textContent=`
            @keyframes fadeInUp {
                from {
                    opacity: 0;
        ...
        `,document.head.appendChild(e)}const t={threshold:.1,rootMargin:"0px 0px -50px 0px"},o=new IntersectionObserver(function(e){e.forEach(a=>{if(a.isIntersecting){const s=a.target.getAttribute("data-delay")||0;setTimeout(()=>{a.target.classList.add("animated")},s),o.unobserve(a.target)}})},t);A(o)}function A(t){const o=window.location.pathname.split("/").pop()||"index.html";o==="brand.html"?P(t):(o==="index.html"||o==="")&&R(t);const e=document.querySelector(".footer-content");e&&(e.classList.add("animate-fade-in"),e.setAttribute("data-delay","100"),t.observe(e))}function P(t){[{selector:".brand-title",delay:100},{selector:".brand-subtitle",delay:200},{selector:".brand-divider",delay:600},{selector:".brand-question",delay:700},{selector:".work-title",delay:100},{selector:".work-cards-container",delay:200}].forEach(({selector:a,delay:s})=>{const i=document.querySelector(a);i&&(i.classList.add("animate-fade-in"),i.setAttribute("data-delay",s.toString()),t.observe(i))}),document.querySelectorAll(".brand-circle").forEach((a,s)=>{a.classList.add("animate-fade-in"),a.setAttribute("data-delay",(300+s*100).toString()),t.observe(a)})}function R(t){[{selector:".middle-image",delay:100},{selector:".service-main-text",delay:200},{selector:".service-description-text",delay:300}].forEach(({selector:r,delay:n})=>{const c=document.querySelector(r);c&&(c.classList.add("animate-fade-in"),c.setAttribute("data-delay",n.toString()),t.observe(c))}),document.querySelectorAll(".work-card").forEach((r,n)=>{r.classList.add("animate-fade-in-up"),r.setAttribute("data-delay",(100+n*150).toString()),t.observe(r)});const a=document.querySelector(".mission-content");a&&(a.classList.add("animate-fade-in-up"),a.setAttribute("data-delay","100"),t.observe(a)),document.querySelectorAll(".team-member").forEach((r,n)=>{r.classList.add("animate-fade-in-up"),r.setAttribute("data-delay",(100+n*200).toString()),t.observe(r)});const i=document.querySelector(".contact-content");i&&(i.classList.add("animate-fade-in-up"),i.setAttribute("data-delay","100"),t.observe(i))}function L(){const t=document.querySelector(".contact-form");if(!t)return;t.addEventListener("submit",q);const o=t.querySelector(".submit-button");o&&o.addEventListener("click",C)}async function q(t){t.preventDefault();const o=z(this);if(!T(o))return;const e=this.querySelector(".submit-button"),a=e.textContent;v(e,!0);try{await new Promise(s=>setTimeout(s,1e3)),console.log("Form submission:",o),alert("제안이 성공적으로 전송되었습니다!\\n\\n문의사항은 previtlab@gmail.com으로 직접 연락 부탁드립니다."),this.reset()}catch(s){console.error("Form submission error:",s),alert("전송 중 오류가 발생했습니다. 다시 시도해주세요.")}finally{v(e,!1,a)}}function z(t){const o=t.querySelectorAll("input"),e={};return o.forEach(a=>{const s=a.placeholder;s&&(e[s]=a.value.trim())}),{name:e.이름||"",email:e.이메일||"",company:e.회사명||"",phone:e.연락처||"",proposal:e["제안 사항"]||""}}function T(t){return!t.name||!t.email||!t.proposal?(alert("이름, 이메일, 제안 사항은 필수 입력 항목입니다."),!1):/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.email)?t.phone&&t.phone.length>0&&!/^[0-9-+\s()]+$/.test(t.phone)?(alert("올바른 연락처 형식을 입력해주세요."),!1):!0:(alert("올바른 이메일 주소를 입력해주세요."),!1)}function v(t,o,e="제안 보내기"){o?(t.textContent="전송 중...",t.disabled=!0):(t.textContent=e,t.disabled=!1)}function C(t){const o=t.currentTarget,e=document.createElement("span"),a=o.getBoundingClientRect(),s=Math.max(a.width,a.height),i=t.clientX-a.left-s/2,r=t.clientY-a.top-s/2;e.style.cssText=`
        width: ${s}px;
        height: ${s}px;
        left: ${i}px;
        top: ${r}px;
        ...
        pointer-events: none;
    `,o.style.position="relative",o.style.overflow="hidden",o.appendChild(e),setTimeout(()=>{e.remove()},600)}function I(){const t=window.location.pathname.split("/").pop()||"index.html";if(t!=="index.html"&&t!=="")return;const o={logoImage:document.querySelector(".logo-image"),logo:document.querySelector(".logo"),mainCopy:document.querySelector(".main-copy"),subCopy:document.querySelector(".sub-copy")};F(o),B()}function F({logoImage:t,logo:o,mainCopy:e,subCopy:a}){if(t&&(t.style.cssText=`
            opacity: 0;
        ...
        `,setTimeout(()=>{e.style.opacity="1",e.style.transform="translateY(0)"},700)),a&&(a.style.cssText=`
            ...
            transform: translateY(30px);
            transition: opacity 1s ease, transform 1s ease;
        `,setTimeout(()=>{a.style.opacity="1",a.style.transform="translateY(0)"},900))}function B(){document.querySelectorAll('a[href^="#"]').forEach(t=>{t.addEventListener("click",function(o){o.preventDefault();const e=document.querySelector(this.getAttribute("href"));e&&e.scrollIntoView({behavior:"smooth",block:"start"})})})}function b(){return`
        <!-- Hero Section -->
    ...
    `}let d;document.addEventListener("DOMContentLoaded",function(){console.log("DOM loaded, initializing SPA"),S(async()=>{const{default:t}=await import("./router-DZbxkp5h.js");return{default:t}},[],import.meta.url).then(({default:t})=>{d=new t,d.addRoute("/home",b),d.addRoute("/",b),d.addRoute("/brand",D),d.addRoute("/product",_),d.addRoute("/blog",O),console.log("Routes registered:",Array.from(d.routes.keys())),d.init(),window.router=d}),k(),E(),L(),I(),document.body.style.opacity="0",document.body.style.transition="opacity 0.5s ease",setTimeout(()=>{document.body.style.opacity="1"},100),console.log("PreVIT SPA loaded successfully")});const x=sessionStorage.getItem("spa-path");x&&(sessionStorage.removeItem("spa-path"),setTimeout(()=>{window.router&&window.router.navigate(x)},100));
